...
Base.prototype.getGeneratedFiles = function () {
    ...
    return {
        ...
        '.github/labels.yml': yamlStringify(sortKeys(githubLabelsConfig, { deep: true })),
        '.github/workflows/build.yml': yamlStringify(sortKeys(this.getGithubWorkflowConfig(), { deep: true })),
        '.github/workflows/deprecated-dependencies.yml': yamlStringify(sortKeys(githubDeprecatedDependenciesConfig, { deep: true })),
        '.github/workflows/sync-labels.yml': yamlStringify(sortKeys(githubSyncLabelsConfig, { deep: true })),
        '.github/workflows/sync-metadata.yml': yamlStringify(sortKeys(this.getGithubSyncMetadataConfig(), { deep: true })),
        ...
        '.renovaterc.json': `${JSON.stringify(sortKeys(this.getRenovateConfig(), { deep: true }), undefined, 2)}\n`,
