...
var _last = _interopRequireDefault(require("@dword-design/functions/dist/last"));
...
var _default = {
  ...
  license: () => {
    var _ref2, _ref3, _config$seeAlso;

    return _ref2 = [(0, _endent.default)`
      ## Contribute
    ...
    `, ...(_config.default.seeAlso.length > 0 ? [(0, _endent.default)`
            ## See Also

            ${(_ref3 = (_config$seeAlso = _config.default.seeAlso, (0, _map.default)(entry => {
      var _entry$repository, _parts;

      const parts = (_entry$repository = entry.repository, (0, _split.default)('/')(_entry$repository));
      const owner = parts.length >= 2 ? parts[0] : 'dword-design';
      const name = (_parts = parts, (0, _last.default)(_parts));
      return `* [${name}](https://github.com/${owner}/${name}): ${entry.description}`;
    })(_config$seeAlso)), (0, _join.default)('\n')(_ref3))}
          `] : []), _packageConfig.default.license ? [(() => {
